        ...
        <main className="min-h-screen font-sans bg-gray-50">
            ...
            <div className="bg-gray-900 text-white py-12 md:py-20 px-6">
                <div className="max-w-4xl mx-auto text-center">
                    <h1 className="text-3xl md:text-5xl font-bold mb-6">Our Services & Pricing</h1>
                    <p className="text-lg md:text-xl text-gray-300">Transparent, competitive rates for all your delivery needs.</p>
                </div>
            </div>
                    ...
                    <div className="space-y-12 md:space-y-16">
                        ...
                        <div>
                            <div className="flex items-center gap-3 mb-6">
                                <Truck className="w-6 h-6 md:w-8 md:h-8 text-amber-500" />
                                <h3 className="text-xl md:text-2xl font-bold text-gray-900">KAELO SEND (Standard Courier)</h3>
                            </div>
                        ...
                        <div>
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h3 className="text-xl md:text-2xl font-bold text-gray-900">KAELO FREIGHT (Goods Delivery)</h3>
                            </div>
                            <div className="overflow-x-auto">
                                <table className="w-full bg-white rounded-xl shadow-sm border border-gray-100 text-sm text-left">
                                    <thead className="bg-gray-900 text-white">
                        ...
                        <div>
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h3 className="text-xl md:text-2xl font-bold text-gray-900">KAELO COMMERCE (E-Commerce Integration)</h3>
                            </div>
                            <div className="overflow-x-auto">
                                <table className="w-full bg-white rounded-xl shadow-sm border border-gray-100 text-sm text-left">
                                    <thead className="bg-gray-900 text-white">
